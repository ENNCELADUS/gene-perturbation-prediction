...
from src.data.q_sc import verify_q_sc_shards
from src.model.geneeffect import GeneEffectE2EModel
from src.data.batches import OnlineConditionBatch
from src.training.distributed import require_distinct_devices, run_rank_zero_or_raise
...
from src.experiments.exp13_legacy.stage2_config import Stage2Config, load_stage2_config
...
from src.model.response import _state_window
...
def build_warmup_batch_factories(
    ...
    *,
    ...
    from src.experiments.exp13_legacy.geneeffect_training_loop import (
        ResidualValidationMetric,
    )
...
def score_dependency_split(
    ...
    *,
    ...
    from src.eval.metrics import per_gene_spearman, per_line_spearman
...
def _recovered_training_outcome(
    ...
    from src.experiments.exp13_legacy.geneeffect_training_loop import _outcome
...
def run_full_stage2(
    ...
    *,
    ...
    try:
        ...
        if recovery is not None:
            _run_rank_zero_long_action(
                ...
                lambda: _import_frozen_feature_store(
                    state,
                    data,
                    recovery.source_root / "condition_features" / "stage1_frozen",
                    frozen_store,
        ...
        from src.model.response import ResponseLoss, ResponseLossWeights
